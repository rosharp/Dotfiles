...
This function should only modify configuration layer settings."
  (setq-default
   ...
   '(typescript
     ...
     pdf
     (elfeed :variables rmh-elfeed-org-files (list "~/org-roam/elfeed.org")))
