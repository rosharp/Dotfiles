...
awful.key({ altkey }, "r", function () awful.util.spawn("alacritty -e ranger") end),
...
---- Screenshot
awful.key({ }, "Print", function () awful.spawn.with_shell("$HOME/.local/share/scripts/screenshot.sh") end), 
awful.key({ "Shift" }, "Print", function () awful.spawn.with_shell("$HOME/.local/share/scripts/FSScreenshot.sh") end), 

---- Bookmark
awful.key({ modkey, "Shift" }, "b", function () awful.spawn.with_shell("$HOME/.local/share/scripts/bookmarkthis") end), 

---- Search
awful.key({ modkey, "Shift" }, "d", function () awful.spawn.with_shell("sh $HOME/.local/share/scripts/dmenu_search.sh") end),
